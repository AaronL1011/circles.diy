	...
	return models.CirclesPageData{
		...
		Circles: []models.Circle{
			{
				...
				Thumbnail:    "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=80&h=80&fit=crop&crop=center",
			...
			},
			{
				...
				Description:  "Local community garden, sustainability discussions, and seasonal gatherings. Growing together, literally and figuratively.",
			...
			},
			{
				...
				Thumbnail:    "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=80&h=80&fit=crop&crop=center",
			...
			},
			{
				ID:           "4",
				Name:         "Local Artists",
				Description:  "Supporting creative community through collaboration, critique, and celebration of local talent.",
			...
			},
			{
				...
				Description:  "Discussing the future of digital communication, platform design, and community building tools.",
				Thumbnail:    "https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=80&h=80&fit=crop&crop=center",
		...
		RecentActivity: []models.CircleActivity{
			...
			},
			{
				...
				CircleID: "4",
				Type:     "member_joined",
				Title:    "New member joined Local Artists",
